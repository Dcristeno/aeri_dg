...
MOE_LOSS_WEIGHT="${MOE_LOSS_WEIGHT:-0.5}"
MOE_AERIAL_TEXT_WEIGHT="${MOE_AERIAL_TEXT_WEIGHT:-1.0}"
MOE_GROUND_TEXT_WEIGHT="${MOE_GROUND_TEXT_WEIGHT:-1.0}"
MOE_AERIAL_GROUND_WEIGHT="${MOE_AERIAL_GROUND_WEIGHT:-1.0}"
MOE_NUM_EXPERTS="${MOE_NUM_EXPERTS:-8}"
MOE_TOP_K="${MOE_TOP_K:-4}"
MOE_REDUCTION="${MOE_REDUCTION:-8}"
MOE_POOL_TOPK="${MOE_POOL_TOPK:-4}"
MOE_RESIDUAL_SCALE="${MOE_RESIDUAL_SCALE:-0.5}"
...
args=(
  ...
  --moe_aerial_text_weight "${MOE_AERIAL_TEXT_WEIGHT}"
  --moe_ground_text_weight "${MOE_GROUND_TEXT_WEIGHT}"
  --moe_aerial_ground_weight "${MOE_AERIAL_GROUND_WEIGHT}"
  --moe_num_experts "${MOE_NUM_EXPERTS}"
  --moe_top_k "${MOE_TOP_K}"
  --moe_reduction "${MOE_REDUCTION}"
  --moe_pool_topk "${MOE_POOL_TOPK}"
