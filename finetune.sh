...
RUN_NAME="${RUN_NAME:-aeri_k2_rep_adapter}"
SEED="${SEED:-1}"
...
REP_ALPHA="${REP_ALPHA:-0.7}"
REP_REG_WEIGHT="${REP_REG_WEIGHT:-0.5}"
REP_HIDDEN_DIM="${REP_HIDDEN_DIM:-1024}"
