...
CAPTION_CHERRY_MODE="${CAPTION_CHERRY_MODE:-off}"
CAPTION_CHERRY_EXTRA_PER_SAMPLE="${CAPTION_CHERRY_EXTRA_PER_SAMPLE:-0}"
CAPTION_CHERRY_WEIGHT="${CAPTION_CHERRY_WEIGHT:-3.0}"
SYNTHETIC_CHERRY_MANIFEST="${SYNTHETIC_CHERRY_MANIFEST:-}"
SYNTHETIC_CHERRY_MIN_SCORE="${SYNTHETIC_CHERRY_MIN_SCORE:-0.0}"
SYNTHETIC_CHERRY_MAX_PER_PID="${SYNTHETIC_CHERRY_MAX_PER_PID:-2}"
SYNTHETIC_CHERRY_WEIGHT="${SYNTHETIC_CHERRY_WEIGHT:-4.0}"
...
args=(
  ...
  --caption_cherry_mode "${CAPTION_CHERRY_MODE}"
  --caption_cherry_extra_per_sample "${CAPTION_CHERRY_EXTRA_PER_SAMPLE}"
  --caption_cherry_weight "${CAPTION_CHERRY_WEIGHT}"
  --synthetic_cherry_manifest "${SYNTHETIC_CHERRY_MANIFEST}"
  --synthetic_cherry_min_score "${SYNTHETIC_CHERRY_MIN_SCORE}"
  --synthetic_cherry_max_per_pid "${SYNTHETIC_CHERRY_MAX_PER_PID}"
  --synthetic_cherry_weight "${SYNTHETIC_CHERRY_WEIGHT}"
