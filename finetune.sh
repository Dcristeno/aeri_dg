...
CFA_LOSS_WEIGHT="${CFA_LOSS_WEIGHT:-1.0}"
CFA_SELECTIVE_WEIGHT="${CFA_SELECTIVE_WEIGHT:-1.0}"
CFA_FTA_WEIGHT="${CFA_FTA_WEIGHT:-0.5}"
CFA_NUM_QUERY="${CFA_NUM_QUERY:-4}"
CFA_QUERY_CONDITION_SCALE="${CFA_QUERY_CONDITION_SCALE:-1.0}"
CFA_SIGMA_FLOOR="${CFA_SIGMA_FLOOR:-1e-6}"
...
args=(
  ...
  --cfa_loss_weight "${CFA_LOSS_WEIGHT}"
  --cfa_selective_weight "${CFA_SELECTIVE_WEIGHT}"
  --cfa_fta_weight "${CFA_FTA_WEIGHT}"
  --cfa_num_query "${CFA_NUM_QUERY}"
  --cfa_query_condition_scale "${CFA_QUERY_CONDITION_SCALE}"
  --cfa_sigma_floor "${CFA_SIGMA_FLOOR}"
