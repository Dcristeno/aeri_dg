...
BRIDGE_NOISE_MIN="${BRIDGE_NOISE_MIN:-0.2}"
BRIDGE_NOISE_TAU="${BRIDGE_NOISE_TAU:-0.1}"
BRIDGE_NOISE_THRESHOLD="${BRIDGE_NOISE_THRESHOLD:-0.0}"
...
args=(
  ...
  --bridge_noise_min "${BRIDGE_NOISE_MIN}"
  --bridge_noise_tau "${BRIDGE_NOISE_TAU}"
  --bridge_noise_threshold "${BRIDGE_NOISE_THRESHOLD}"
