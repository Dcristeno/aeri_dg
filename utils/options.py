...
def get_args():
    ...
    parser.add_argument("--bridge_mode", type=str, default="plain", help="bridge loss mode: plain, gated, or noise_gated")
    ...
    parser.add_argument("--bridge_noise_min", type=float, default=0.2, help="minimum sample reliability for noise-gated bridge loss")
    parser.add_argument("--bridge_noise_tau", type=float, default=0.1, help="temperature for noise-gated bridge reliability")
    parser.add_argument("--bridge_noise_threshold", type=float, default=0.0, help="similarity threshold for noise-gated bridge reliability")
