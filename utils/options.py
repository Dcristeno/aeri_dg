...
def get_args():
    ...
    parser.add_argument("--moe_loss_weight", type=float, default=0.5, help="overall weight for the AERI MoE auxiliary alignment loss")
    parser.add_argument("--moe_aerial_text_weight", type=float, default=1.0, help="weight for MoE aerial-text alignment")
    parser.add_argument("--moe_ground_text_weight", type=float, default=1.0, help="weight for MoE ground-text alignment")
    parser.add_argument("--moe_aerial_ground_weight", type=float, default=1.0, help="weight for MoE aerial-ground alignment")
    parser.add_argument("--moe_num_experts", type=int, default=8, help="number of adapter experts in the AERI MoE module")
    parser.add_argument("--moe_top_k", type=int, default=4, help="number of experts selected per token in the AERI MoE module")
    parser.add_argument("--moe_reduction", type=int, default=8, help="bottleneck reduction ratio for each AERI MoE adapter expert")
    parser.add_argument("--moe_pool_topk", type=int, default=4, help="number of adapted local tokens pooled into the MoE feature")
    parser.add_argument("--moe_residual_scale", type=float, default=0.5, help="residual scale for the token-level AERI MoE adapter")
