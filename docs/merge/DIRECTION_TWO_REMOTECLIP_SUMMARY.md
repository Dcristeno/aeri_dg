...
Note: this remains the best direction-two result. It is no longer the global best after adding the direction-three HardNeg expert. See `DIRECTION_THREE_HARDNEG_RESULTS.md` for the current global best:
